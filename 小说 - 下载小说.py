# 目录列表：http://seputu.com/   http://www.yinyangdailiren.org/
# 章节目录：http://seputu.com/biji1/1.html  http://www.yinyangdailiren.org/lin-yi-shi-jie/1.html
# 把书的名称，章节，章节名称，章节链接抽取出来，存储到数据库中，同时将文章的内容提取出来存成txt文件。

# 利用Python3 编写爬虫，从笔趣阁抓个小说下载到手机查看
# 小说地址 http://www.biquge.com.tw/0_213/
import re
...
# 简单方式
response = urllib.request.urlopen(root,timeout=1)
