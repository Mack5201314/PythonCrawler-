...
msg = "输入小说地址，例如http://www.biquge.com.tw/0_213/"  # http://www.biquge5200.com/59_59737/
title = '爬虫'
...
# 匹配所有目录http://www.biquge.com.tw/0_213/"  http://www.biquge5200.com/59_59737/
story_id = root.lstrip("http://www.biquge.com.tw/")
#story_id = root.lstrip("http://www.biquge5200.com/")
dir_req = re.compile(r'<a href="/%s(\d+?.html)">'%story_id)
dirs = dir_req.findall(htmls)

# 创建文件流，将各个章节读入内存
with open('E:\黑暗文明.txt', 'w') as f:
    for dir in dirs:
        # 组合链接地址，即各个章节的地址
        url = root + dir
