...
seed_url = "http://cxbz958.com/"   #------修改地方1
user_agent = 'Mozilla/5.0 (Windows NT 10.0; WOW64) ' \
             'AppleWebKit/537.36 (KHTML, like Gecko) ' \
             'Chrome/63.0.3239.132 Safari/537.36'
headers = {'User-Agent': user_agent}
link_regex = '/index|jingjuegucheng|longlingmiku|yunnanchonggu|' \
             'kunlunshengong|huangpizifen|nanhaiguixu|nuqingxiangxi|' \
             'wuxiaguanshan|muyeguishi|shengquanxunzong|fuxiandugu|' \
             'shanhaiyaozhong|xiangxiyiling|zhenkukuangsha|zeimao|' \
             'mizongzhiguo|guibuyu|guaitan|jiuyoujiangjun|nanhuanggumu'  #------修改地方2
