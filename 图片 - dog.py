...
def download(seed_url):
    for num in range(10):
        ipdict = IPspider(1).items()
        for i in ipdict:
            ipport = i[0]+":"+i[1]
            # 设置header
            headers = set_user_agent()
            useragent = str(headers.values())
...
#url = "https://3eeeww.com/intr/ae4885859b943474"
url = r"https://fffdd5.win/intr/ae4885859b943474"

download(seed_url=url)
